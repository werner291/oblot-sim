...
public class FxFXMLController implements RobotView.RobotManager
{
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (System.currentTimeMillis() > lastFrametime + 1000.0f / frameRate.get()) {
                    ...
                    if (!isPaused.get()) {
                        robotInteractionManager.recomputeRobots(dragBarSimulation.getValue());
                        playDragBar();
                    }
    ...
    private void resetSimulation(double localTimeStamp) {
        ...
        robotInteractionManager.recomputeRobots(localTimeStamp);
...
//    }
    ...
    private void onSelectScheduler(ActionEvent actionEvent, Supplier<Scheduler> schedulerSupplier, boolean force) {
